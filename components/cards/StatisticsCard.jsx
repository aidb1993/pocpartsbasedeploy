...
const StatisticsCard = ({
  ...
  }, [partNumber, activeSellers, searched, sellersLink, searchesDescription]);

  return (
    <div className="card-wrapper text-dark100_light900 grid h-auto grid-cols-1 gap-4 rounded-[10px] p-4 shadow-custom sm:p-6 md:grid-cols-2 md:p-16">
      <div className="flex flex-col items-center justify-center border-b pb-4 text-center md:border-b-0 md:border-r md:pb-0 md:pr-4">
        <h2 className="h2-semibold mb-2">{partNumber}</h2>
